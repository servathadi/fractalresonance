...
describe('Schema.org generators', () => {
  describe('schemaWebSite', () => {
    it('should generate valid WebSite schema', () => {
      ...
      expect(schema.name).toBe('Fractal Resonance Coherence');
  ...
  describe('schemaScholarlyArticle', () => {
    ...
    it('should include video if provided', () => {
      ...
      expect((schema.video as { '@type': string })['@type']).toBe('VideoObject');
    });
  });
  ...
  describe('schemaBook', () => {
    ...
    it('should include chapters if provided', () => {
      ...
      const chapters = schema.hasPart as Array<{ '@type': string }>;
