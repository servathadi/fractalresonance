...
import { getTopics, isCurrentReadingContent, matchesPerspectiveView, type PerspectiveView } from '@/lib/content';
...
export function TopicsSidebar({ lang, currentId, basePath, view, variant = 'desktop' }: TopicsSidebarProps) {
  const topics = getTopics(lang)
    .filter((t) => isCurrentReadingContent('topic', t.frontmatter) && (view ? matchesPerspectiveView(t.frontmatter.perspective, view) : true))
