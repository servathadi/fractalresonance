    ...
    <aside data-sidebar className={asideClass}>
      {isMobile ? (
        <details className="group">
          <summary className="flex items-center justify-between px-4 py-3 text-sm text-frc-text cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden">
    ...
    <details open={openByDefault} className="mb-4 group">
      <summary className="flex items-center justify-between gap-3 text-xs uppercase tracking-wider text-frc-steel px-2 cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden">
        <div className="flex items-center gap-2">
          <svg
            className="w-3 h-3 text-frc-steel transition-transform motion-reduce:transition-none group-open:rotate-90"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
