...
function SidebarSection({
  ...
  return (
    <details open={openByDefault} className="mb-4 group">
      <summary className="flex items-center justify-between gap-3 text-xs uppercase tracking-wider text-frc-steel px-2 cursor-pointer select-none list-none hover:text-frc-text transition-colors">
