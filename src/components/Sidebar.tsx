    ...
    <aside data-sidebar className={asideClass}>
      {isMobile ? (
        <details className="group">
          <summary className="px-4 py-3 text-sm text-frc-text cursor-pointer select-none list-none flex items-center gap-2">
            <svg
              className="w-4 h-4 transition-transform group-open:rotate-90 text-frc-steel"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth="2"
    ...
    <details open={openByDefault} className="group mb-4">
      <summary className="flex items-center justify-between gap-3 text-xs uppercase tracking-wider text-frc-steel px-2 cursor-pointer select-none list-none">
        <div className="flex items-center gap-2">
          <svg
            className="w-3.5 h-3.5 transition-transform group-open:rotate-90 text-frc-steel/70"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="2"
