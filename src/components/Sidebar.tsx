      ...
      {isMobile ? (
        <details className="group">
          <summary className="px-4 py-3 text-sm text-frc-text cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden flex items-center justify-between">
            ...
            <svg
              className="w-4 h-4 transition-transform group-open:rotate-180 text-frc-text-dim"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              aria-hidden="true"
    ...
    <details open={openByDefault} className="mb-4 group">
      <summary className="flex items-center justify-between gap-3 text-xs uppercase tracking-wider text-frc-steel px-2 cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden">
        <div className="flex items-center gap-2">
          <svg
            className="w-3 h-3 transition-transform group-open:rotate-90 text-frc-text-dim"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
