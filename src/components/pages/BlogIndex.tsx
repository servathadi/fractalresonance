import { estimateReadTime, getBlogPosts, isCurrentReadingContent, matchesPerspectiveView, type PerspectiveView } from '@/lib/content';
...
export function BlogIndex({
  ...
  const posts = getBlogPosts(lang)
    .filter((p) => isCurrentReadingContent('blog', p.frontmatter) && matchesPerspectiveView(p.frontmatter.perspective, view))
