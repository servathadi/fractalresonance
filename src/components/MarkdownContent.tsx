...
export function MarkdownContent({ html, glossary }: MarkdownContentProps) {
  ...
  // Memoize sanitized HTML to avoid double renders and hydration empty states
  // Optimization: useMemo instead of useState+useEffect ensures content is ready on first render,
  // improving LCP and preventing CLS.
