...
export function InlineToc({
  ...
  return (
    <details className={`group ${hideClass} mb-6 border border-frc-blue rounded-lg ${className}`}>
      <summary className="list-none flex items-center justify-between px-4 py-3 text-sm text-frc-text cursor-pointer select-none rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-frc-gold">
