  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={copied ? 'Text copied' : 'Copy selected text'}
        className="focus-visible:ring-2 focus-visible:ring-frc-gold focus-visible:outline-none rounded-sm"
      >
        {copied ? (
      ...
      <button
        ...
        title="Share on X"
        aria-label="Share selection on X (Twitter)"
        className="focus-visible:ring-2 focus-visible:ring-frc-gold focus-visible:outline-none rounded-sm"
      >
