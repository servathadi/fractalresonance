...
export function TextSharePopover() {
  ...
  return (
    ...
    >
      ...
      {/* Twitter/X */}
      <button onClick={shareTwitter} title="Share on X" aria-label="Share selection on X (Twitter)">
      ...
      {/* Share link */}
      <button onClick={shareLink} title="Copy page link" aria-label="Copy link to this page">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
