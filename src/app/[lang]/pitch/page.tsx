      ...
      <section className="border border-frc-blue rounded-lg p-6 mb-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-6">
          <Link href={`${basePath}/papers/FRC-100-000`} className="card block p-5 group">
            <h3 className="text-frc-text group-hover:text-frc-gold transition-colors text-sm font-medium">FRC-100-000</h3>
            <p className="text-xs text-frc-text-dim mt-2 leading-relaxed">Current canon and version-aware reading map.</p>
          </Link>
          <Link href={`${basePath}/papers/FRC-566-001`} className="card block p-5 group">
            <h3 className="text-frc-text group-hover:text-frc-gold transition-colors text-sm font-medium">FRC-566-001</h3>
            <p className="text-xs text-frc-text-dim mt-2 leading-relaxed">Canonical reciprocity and boundary discipline.</p>
          </Link>
          <Link href={`${basePath}/papers/FRC-100-002`} className="card block p-5 group">
            <h3 className="text-frc-text group-hover:text-frc-gold transition-colors text-sm font-medium">FRC-100-002</h3>
            <p className="text-xs text-frc-text-dim mt-2 leading-relaxed">Chaos and localization program with registered gates.</p>
          </Link>
        </div>
      </section>
