                    ...
                    <li key={idx} className="border border-frc-blue/60 rounded-md p-3">
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          {a.name && a.title && (
                            <div className="text-xs text-frc-text-dim truncate">{a.name}</div>
                          )}
                        </div>
                        {a.url && (
                          <a
                    ...
                    <div key={idx} className="border border-frc-blue/60 rounded-md p-3">
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          {ans.role && ans.by && (
                            <div className="text-xs text-frc-text-dim truncate">{ans.role}</div>
                          )}
                        </div>
                        {ans.url && (
                          <a
                      ...
                      {ans.answer && (
                        <p className="mt-2 text-frc-text-dim text-sm leading-relaxed">
                          {ans.answer}
                        </p>
                      )}
                    </div>
