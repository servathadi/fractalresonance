...
export const metadata: Metadata = {
  title: 'Topics',
  description: 'Questions, summaries, and spectrum views across the Fractal Resonance Coherence corpus.',
};
...
export default async function TopicsPage({ params }: Props) {
  ...
  const collectionSchema = schemaCollectionPage(
    'FRC Topics',
    'Questions, summaries, and spectrum views across the Fractal Resonance Coherence corpus.',
