  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="border border-frc-blue rounded-lg p-6 mb-12 bg-frc-void/20">
        <h2 className="text-sm text-frc-steel uppercase tracking-wider mb-4">Current claim boundaries</h2>
        <ul className="space-y-2 text-sm text-frc-text-dim">
          <li>- Canonical relation: dS + k* d ln C = 0</li>
          <li>- Operational realizations declare scale, observables, units, and boundary</li>
          <li>- Exact identities and model-specific computations retain their tested scope</li>
          <li>- Born-equilibrium and collapse mechanisms remain conditional proposals</li>
          <li>- A fundamental Lambda field and universal physical reciprocity remain conjectural</li>
        </ul>
      </div>
