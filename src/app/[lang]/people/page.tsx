...
export const metadata: Metadata = {
  title: 'Voices',
  description: 'Contributors and declared roles for the Fractal Resonance Coherence corpus.',
};
...
export default async function PeoplePage({ params }: Props) {
  ...
  const collectionSchema = schemaCollectionPage(
    'FRC Voices',
    'Contributors and declared roles for the Fractal Resonance Coherence corpus.',
