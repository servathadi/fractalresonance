...
import { getArticles, getPapers, getLanguages, isCurrentReadingContent } from '@/lib/content';
...
export async function GET() {
  ...
  for (const lang of languages) {
    ...
    for (const article of articles) {
      ...
      const thumbnailUrl = video.thumbnailUrl || getYouTubeThumbnail(youtubeUrl) || `${SITE_URL}/brand/sigil-64.png`;
