...
// Wrapped in cache to deduplicate I/O requests.
// This ensures that multiple components requesting the same data (e.g. Layout + Page)
// only trigger one file system read per request/build pass.
