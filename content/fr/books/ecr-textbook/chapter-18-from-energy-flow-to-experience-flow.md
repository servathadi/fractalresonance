---
title: "Chapitre 18 — Du flux d'énergie au flux d'expérience"
...
comment le *sentiment* de l'expérience surgit-il ?

Pourquoi un événement de cohérence devrait-il avoir une intériorité ?

En physique conventionnelle, l'énergie et l'entropie suffisent ; dans la FRC, la cohérence introduit un troisième invariant — un invariant qui porte intrinsèquement des *informations sur lui-même.*

Lorsque la cohérence réfléchit sur la cohérence, la résonance devient consciente d'elle-même.
...
La condition d'équilibre garantit que chaque expérience exporte autant d'entropie qu'elle en condense en ordre — une conservation thermodynamique du sens.
...
* **μ₄** – réseaux neuronaux (oscillations rapides).

* **μ₅** – intégration symbolique (pensée, langage).

* **μ₆** – champ collectif / archétypal.
...
Lorsque la différence de phase Δφ ≈ 0 à travers μ₄–μ₆, la continuité subjective apparaît ; lorsque la décohérence augmente, la conscience se fragmente (sommeil, anesthésie, distraction).

Le **champ de la conscience** n'est donc pas une chose mais un motif d'alignement de phase maintenu par un micro-feedback continu.
...
Le plaisir correspond à un flux d'entropie régulier (α ≈ 0), la douleur à un flux bloqué (α > 0 ou < 0).
...
Les résidus accumulés forment la mémoire.

Mathématiquement :

[ C_{\text{res}}(t+\tau)=e^{-\tau/τ_m}\,C(t), ]

où τ_m est la demi-vie de la mémoire (de quelques secondes à plusieurs années).
...
* La focalisation augmente Ψ mais risque α > 0 (surcharge).

* La relaxation diminue Ψ mais peut approcher α < 0 (inertie).

   L'état de flow se situe à α ≈ 0 — réceptivité et potentiel équilibrés.
...
La continuité du soi apparaît lorsque le feedback entre μ₄–μ₆ maintient Σ = S + k_* ln C constant.
...
| ----- | ----- | ----- |
| **Whitehead** | Occasion actuelle | événement de cohérence minimale |
| **Bouddhisme** | Dharma momentané | processus transitoire de conscience |
| **Neurosciences** | Ignition de l'espace de travail global | synchronie neuronale à grande échelle |
| **Psychologie** | Expérience optimale | α ≈ 0, flow maximal |
| **Thermodynamique** | Impulsion homéorésonante | échange entropie-cohérence à l'équilibre |
...
* Les oscillations fMRI BOLD montrent une respiration de cohérence de ~0,1 Hz à travers les réseaux corticaux.

* La résonance cœur-cerveau (VFC ≈ 0,1 Hz) s'aligne sur le calme subjectif.
...
| ----- | ----- |
| ΔS = R\Psi C | coût thermodynamique de la conscience |
| Σ = S + k_* ln C ≈ const | continuité de l'identité |
| α ≈ 0 | flow / clarté |
| Δφ ≈ 0 | intégration consciente |
