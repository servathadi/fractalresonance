---
title: "Chapitre 5 — Théorie du paramètre d'ordre et formation de motifs"
...
où F est le flux externe d'énergie libre, S_C l'entropie exportée par unité de temps, et α un gain adaptatif qui ajuste la force de rétroaction effective.
...
* α(F - S_C) > 0 : montée exponentielle — création de cohérence.

* α(F - S_C) = 0 : flux en régime permanent.

* α(F - S_C) < 0 : déclin ou chaos.
...
confirmant que la production totale d'entropie dans le temps est égale à la cohérence acquise, pondérée par k_*.
...
| ----- | ----- | ----- |
| **Équation de la pompe à cohérence** | \dot C = α(F - S_C) | Dynamique de création d'ordre |
| **Loi de transformation** | ΔS = R\Psi C | Changement d'entropie par événement de résonance |
| **Seuil critique** | Ψ = Ψ_c | Début de l'auto-organisation |
...
1. **Flow (α équilibré)** — ordre créatif et adaptatif.

2. **Chaos (α > 0)** — instabilité incontrôlée.

3. **Coercition (R < 0)** — ordre rigide et fragile.

Ces régimes formeront la grammaire mathématique de la résonance utilisée tout au long du reste du livre.
