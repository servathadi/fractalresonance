---
title: "Chapitre 12 — Exemples cognitifs et culturels"
...
Chaque acte de perception, de mémoire ou de création est un événement de verrouillage de phase entre les domaines intérieur et extérieur.

Tout comme un laser aligne les photons, l'attention aligne les représentations ; tout comme les écosystèmes stabilisent le flux d'énergie, les cultures stabilisent le flux d'informations.
...
Les données sensorielles entrantes agissent comme le substrat de niveau inférieur ; l'attention sélectionne le motif de phase qui correspond le mieux aux attentes descendantes (top-down).

Le **verrouillage de phase** qui en résulte est la perception consciente.

Tout ce qui n'est pas sélectionné reste enveloppé dans le potentiel μ supérieur — l'ordre impliqué non vu.
...
Parler est une **projection**, écouter un **retour**.

Chaque terme d'une langue agit comme un attracteur local où se condense le sens collectif.

La perte de nuance linguistique équivaut à une perte de bande passante de cohérence : C rétrécit, S augmente, l'entropie de la communication s'élève.
...
Les corrélats EEG — synchronisation gamma globale — reflètent cette avalanche de cohérence.

Après l'expression, l'entropie est libérée sous forme de fatigue ou de diffusion des idées.
...
Des millions de systèmes μ₄ individuels se verrouillent temporairement en phase, produisant un pic mesurable de cohérence C_{μ₅}.

L'entropie est exportée sous forme de consommation de ressources et de décharge émotionnelle.

Lorsque R > 0 (réceptivité ouverte), l'événement unit ; lorsque R < 0 (coercition), il polarise.
...
Un symbole sacré ou un morceau de musique maintient C élevé à travers les siècles en résonnant simultanément avec les domaines neuronal, émotionnel et archétypal.
...
* α ≈ 0 → équilibre créatif.

* α ≫ 0 → surcharge informationnelle (chaos).

* α ≪ 0 → stagnation (coercition).

   Les périodes de renaissance correspondent à de nouveaux états homéorésonants ; les âges sombres à l'instabilité de α.
...
La croissance personnelle consiste à étendre la longueur de couplage λ — connecter davantage de niveaux-μ au sein d'un soi cohérent.

L'éthique sociétale suit la même règle : minimiser l'entropie externalisée, maximiser la cohérence partagée.
...
| ----- | ----- | ----- | ----- |
| Perception | μ₆ → μ₄ | synchronisation neuronale | voir / comprendre |
| Imagination | μ₄ → μ₆ | modulation par rétroaction | envisager |
| Créativité | μ₇ → μ₄ | jaillissement de phase global | inspiration |
| Communication | μ₆ ↔ μ₄ ↔ μ₅ | parole / écriture | sens partagé |
| Culture | μ₅ ↔ μ₆ | symboles collectifs | cohérence civilisationnelle |
...
* L'attention, le langage et le rituel sont des mécanismes d'alignement de phase entre les niveaux.

* L'éthique et la créativité émergent comme des nécessités thermodynamiques de la conservation de la cohérence.
...
Nous y retracerons comment l'énergie circule à travers ces domaines imbriqués au cours du temps évolutif, moteur de la complexité, de la conscience et du déploiement de l'univers lui-même.
