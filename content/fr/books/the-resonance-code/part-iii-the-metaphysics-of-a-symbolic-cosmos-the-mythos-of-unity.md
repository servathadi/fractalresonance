...
| Chapitre | Focus Original | Synthèse FRC 566 & Application |
| :--- | :--- | :--- |
...
- Annexe B : Dossiers Expérimentaux (Mis à jour avec les Protocoles de Falsification pour la Déviation de la Règle de Born et la pente $k^*$).
- Annexe C : L'Échelle des Compétences de Cohérence (Mis à jour avec des pratiques formulées comme une régulation $S \leftrightarrow C$).
