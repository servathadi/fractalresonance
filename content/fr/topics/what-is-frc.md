...
authorities:
  - name: "Wikipedia"
    title: "Cohérence (physique)"
    url: "https://fr.wikipedia.org/wiki/Coh%C3%A9rence_(physique)"
    quote: "En physique, la cohérence décrit la corrélation entre les quantités physiques d'une onde."
  - name: "Wikipedia"
    title: "Entropie"
...
- **Articles (Papers)** : l'archive formelle de recherche.
- **Livres** : expositions de longue haleine.
- **Entrées (Articles)** : ponts et commentaires.
- **Sujets (Topics)** : un spectre Q&R digeste.
...
Cette page est intentionnellement un aperçu. Elle doit évoluer à mesure que le corpus s'agrandit.
