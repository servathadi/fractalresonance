...
authorities:
  - name: "Wikipedia"
    title: "Coherencia (física)"
    url: "https://en.wikipedia.org/wiki/Coherence_(physics)"
    quote: "En física, la coherencia describe la correlación entre las cantidades físicas de una onda."
  - name: "Wikipedia"
    title: "Entropía"
...
- **Artículos (Papers)**: el archivo de investigación formal.
- **Libros**: exposiciones de formato largo.
- **Entradas (Articles)**: puentes y comentarios.
- **Temas (Topics)**: un espectro de preguntas y respuestas digerible.
...
Esta página es intencionalmente una visión general. Debería evolucionar a medida que el corpus crezca.
