...
| Capítulo | Enfoque Original | Síntesis FRC 566 y Aplicación |
| :--- | :--- | :--- |
...
- Apéndice B: Dossiers Experimentales (Actualizado con Protocolos de Falsación para la Desviación de la Regla de Born y la pendiente $k^*$). 
- Apéndice C: La Escalera de Habilidades de Coherencia (Actualizado con prácticas enmarcadas como regulación $S \leftrightarrow C$). 
