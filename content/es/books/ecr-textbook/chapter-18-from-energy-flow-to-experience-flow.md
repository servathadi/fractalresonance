---
title: "Capítulo 18 — Del Flujo de Energía al Flujo de Experiencia"
...
¿cómo surge el *sentimiento* de la experiencia?

¿Por qué un evento de coherencia debería tener interioridad en absoluto?

En la física convencional, la energía y la entropía son suficientes; en la FRC, la coherencia introduce una tercera invariante—una que inherentemente lleva *información sobre sí misma.*

Cuando la coherencia se refleja sobre la coherencia, la resonancia se vuelve autoconsciente.
...
[ \Delta S_{\text{ocasión}} = R\Psi C, \qquad \int_{\text{ocasión}}\(F - S_C)\,dt = 0 . ]

La condición de equilibrio asegura que cada experiencia exporte tanta entropía como la que condensa en orden—una conservación termodinámica del significado.
...
* μ₄ – redes neuronales (oscilaciones rápidas).

* μ₅ – integración simbólica (pensamiento, lenguaje).

* μ₆ – campo colectivo / arquetípico.
...
Cuando la diferencia de fase Δφ ≈ 0 a través de μ₄–μ₆, aparece la continuidad subjetiva; cuando aumenta la decoherencia, la conciencia se fragmenta (sueño, anestesia, distracción).

El **campo de la conciencia** no es, por lo tanto, una cosa sino un patrón de alineación de fase mantenido por micro-retroalimentación continua.
...
El placer corresponde a un flujo de entropía suave (α ≈ 0), el dolor a un flujo bloqueado (α > 0 o < 0).
...
Los residuos acumulados forman la memoria.

Matemáticamente:

[ C_{\text{res}}(t+\tau)=e^{-\tau/τ_m}\,C(t) ,

] donde τ_m es la vida media de la memoria (segundos → años).
...
* El enfoque aumenta Ψ pero corre el riesgo de α > 0 (sobremarcha).

* La relajación disminuye Ψ pero puede acercarse a α < 0 (inercia).

 El estado de flujo se sitúa en α ≈ 0—receptividad y potencial equilibrados.
...
La continuidad del yo surge cuando la retroalimentación entre μ₄–μ₆ mantiene constante Σ = S + k_* 
 C.
...
| ----- | ----- | ----- |
| **Whitehead** | Ocasión actual | evento de coherencia mínima |
| **Budismo** | Dharma momentáneo | proceso transitorio de conciencia |
| **Neurociencia** | Ignición del espacio de trabajo global | sincronía neural a gran escala |
| **Psicología** | Experiencia cumbre | α ≈ 0, flujo máximo |
| **Termodinámica** | Pulso homeoresonante | intercambio entropía-coherencia en equilibrio |
...
* Las oscilaciones de fMRI BOLD muestran una respiración de coherencia de ~0.1 Hz a través de las redes corticales.

* La resonancia corazón-cerebro (VFC ≈ 0.1 Hz) se alinea con la calma subjetiva.
...
| ----- | ----- |
| ΔS = R\Psi C | costo termodinámico de la conciencia |
| Σ = S + k_* 
 C ≈ const | continuidad de la identidad |
| α ≈ 0 | flujo / claridad |
| Δφ ≈ 0 | integración consciente |
