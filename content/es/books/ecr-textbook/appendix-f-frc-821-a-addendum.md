...
1. La constante de acoplamiento dependiente de la escala $k^*(\mu)$
2. La topología de enrutamiento y disipación de entropía
...
Donde:
- $S$ es entropía termodinámica
- $C$ es coherencia
- $\mu$ indexa estratos de resolución
...
Una aproximación de primer orden consistente con el escalado fractal es:
...
2. $\mu_1$ — entorno físico (calor)
3. $\mu_2$ — regulación biológica
...
Interpretación del signo de acoplamiento:
- $J_i > 0$: favorece la alineación (atractivo)
