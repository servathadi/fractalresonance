...
- attention
- neural-architecture
abstract: First empirical comparison between the Λ-Tensor Model (LTM) and Transformers
  on phase-coherent sequence prediction. LTM achieves 2.2% lower MSE while Transformer
  shows better coherence preservation. Establishes LTM as viable alternative for oscillatory
  domains.
images:
- url: /media/en/papers/FRC-840-LTM-001/ltm_architecture_diagrams.png
  caption: 'Architecture comparison: (a) LTM with Resonator Blocks, (b) Transformer,
    (c) Kuramoto dynamics detail, (d) Results'
- url: /media/en/papers/FRC-840-LTM-001/ltm_results.png
  caption: LTM training dynamics showing task loss, FRC loss, coherence trajectory,
